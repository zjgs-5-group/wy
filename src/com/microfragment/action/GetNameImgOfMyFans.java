...
public class GetNameImgOfMyFans {
private int uno;
	...
	public String execute() throws IOException{
		...
		for(int j= 0;j<mineDao.getUaliasImgOfMyFansMyFocu(uno).size();j++){
			
		    jsonArrayList.add(gson.toJson(mineDao.getUaliasImgOfMyFansMyFocu(uno).get(j)));
		}
