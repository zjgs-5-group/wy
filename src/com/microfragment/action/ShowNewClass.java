...
private int uno;
	...
	public String execute() throws IOException{
		...
		for(int j= 0;j<messageDao.showNewComment(uno, commentTimeString).size();j++){
			
		    jsonArrayList.add(gson.toJson(messageDao.showNewComment(uno, commentTimeString).get(j)));
		}
