...
/**
 * ThombId entity. @author MyEclipse Persistence Tools
 */

public class ThombId implements java.io.Serializable {
	...
	/** full constructor */
	public ThombId(Integer tunoactive, Integer eno, String tdate) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThombId))
			return false;
		ThombId castOther = (ThombId) other;
